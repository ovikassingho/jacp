package org.jacp.swing.demo1.util;
...
public class DropShadowPanel extends JComponent {
	...
	public Dimension getPreferredSize() {
		...
		if (original == null) {
			...
			size = new Dimension(original.getWidth() + (distance + shadowSize)
					* 2, original.getHeight() + (distance + shadowSize) * 2);
		}
		return size;
	}
	...
	private BufferedImage prepareImage(BufferedImage image) {
		BufferedImage subject = new BufferedImage(image.getWidth() + shadowSize
				* 2, image.getHeight() + shadowSize * 2,

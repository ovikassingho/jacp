 ...
 *
 ************************************************************************/
package com.trivadis.techevent.util;
...
public class ContentGenerator {
	...
	private static final String[] firstNames = { "Walter", "Hans", "Peter", "Maria",
	...
	private static final String[] address = { "Concord Street", "Trails End Road 3",
			...
			"Zuerichsee 3" };
	private static final String[] zip = { "0234", "2343", "3345", "2346", "2342",
			"22334", "4432", "2344", "4432", "2342", "234223", "2342" };
	private static final String[] phones = { "34535453453", "345345345", "45645654",
			"47645634", "23452342", "23423423", "234234234", "234234211",
			"446564", "475457433", "2343413", "4645456456" };
	private static final String[] country = { "DE", "US", "RU", "BE", "CH", "GB",
			"FR", "DE", "US", "RU", "BE", "FR" };
	...
	public static ContactDTO createEntries(final ContactDTO dto) {
		...
		for (int i = 0; i < amount; i++) {
			...
			contact.setFirstName(firstNames[random()]);

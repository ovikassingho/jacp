...
@DeclarativeComponent(defaultExecutionTarget = "PmainContentTop", id = "id006", name = "XMLTestView", active = true, uiDescriptionFile = "/AdoptionForm.fxml")
public class XMLTestView extends AFXMLComponent {
	...
	@Override
	public void postHandleAction(Node xmlParent, Node handleNode,
			IAction<Event, Object> action) {
		// TODO Auto-generated method stub
		System.out.println("postHandle : "+ grid+ " "+action.getLastMessage()+" thread"+ Thread.currentThread());
		if(!action.getLastMessage().equals(MessageUtil.INIT)) field1.setText(action.getLastMessage().toString());

...
public class OSXBottomBarPanel extends JPanel {
    ...
    private static final Color OS_X_BOTTOM_BAR_ACTIVE_TOP_COLOR = new Color(
	    0xbbbbbb);
    private static final Color OS_X_BOTTOM_BAR_ACTIVE_BOTTOM_COLOR = new Color(
	    0x969696);
    private static final Color OS_X_BOTTOM_BAR_INACTIVE_TOP_COLOR = new Color(
	    0xe3e3e3);
    private static final Color OS_X_BOTTOM_BAR_INACTIVE_BOTTOM_COLOR = new Color(
	    0xcfcfcf);
    private static final Color OS_X_BOTTOM_BAR_BORDER_HIGHLIGHT_COLOR = new Color(
	    0xd8d8d8);
    private static final Color OS_X_UNIFIED_TOOLBAR_FOCUSED_BOTTOM_COLOR = new Color(
	    64, 64, 64);
    private static final Color OS_X_UNIFIED_TOOLBAR_UNFOCUSED_BORDER_COLOR = new Color(
	    135, 135, 135);
